...
const teamHandler = async ctx => {
    ...
    await ctx.reply(`Mancano SOLO ${hours} ore, ${minutes} minuti e ${seconds} secondi a Venerdì!`);
};
...
const luigiHandler = async ctx => {
    ...
    await ctx.reply(`Dai, che anche oggi tra APPENA ${hours} ore saremo a casa!`);
};
